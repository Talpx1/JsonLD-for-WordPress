...
class BusOrCoach extends Vehicle{
	protected string|null $acrissCode = null;
	protected QuantitativeValue|null $roofLoad = null;
	...
	public function description():string {
		return __("A bus (also omnibus or autobus) is a road vehicle designed to carry passengers. Coaches are luxury busses, usually in service for long distance travel.", 'jsonld-for-wordpress');
	}
}