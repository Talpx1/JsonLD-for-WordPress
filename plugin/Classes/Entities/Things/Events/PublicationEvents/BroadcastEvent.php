...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Events\PublicationEvents;
...
class BroadcastEvent extends PublicationEvent{
	protected Event|null $broadcastOfEvent = null;
	protected bool|null $isLiveBroadcast = null;
	protected Language|string|null $subtitleLanguage = null;
	protected string|null $videoFormat = null;
	protected Organization|Person|null $publishedBy = null;
	protected BroadcastService|null $publishedOn = null;
	...
	public function description():string {
		return __("An over the air or online broadcast event.", 'jsonld-for-wordpress');
	}
}