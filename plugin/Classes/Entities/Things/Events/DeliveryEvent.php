...
class DeliveryEvent extends Event{
	protected string|null $accessCode = null;
	protected DateTime|null $availableFrom = null;
	protected DateTime|null $availableThrough = null;
	...
	public function description():string {
		return __("An event involving the delivery of an item.", 'jsonld-for-wordpress');
	}
}