...
use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Movie;
...
class ScreeningEvent extends Event{
	...
	protected Movie|null $workPresented = null;
	...
	public function description():string {
		return __("A screening of a movie or other video.", 'jsonld-for-wordpress');
	}
}