...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Events;
...
class CourseInstance extends Event{
	protected string|null $courseMode = null;
	protected Schedule|null $courseSchedule = null;
	protected string|null $courseWorkload = null;
	protected Person|null $instructor = null;
	...
	public function description():string {
		return __("An instance of a Course which is distinct from other instances because it is offered at a different time or location or through different media or modes of study or to a specific section of students.", 'jsonld-for-wordpress');
	}
}