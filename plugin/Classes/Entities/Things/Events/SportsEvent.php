...
class SportsEvent extends Event{
	...
	protected Person|SportsTeam|null $competitor = null;
	protected Person|SportsTeam|null $homeTeam = null;
	protected string|null $sport = null;
	...
	public function description():string {
		return __("Event type: Sports event.", 'jsonld-for-wordpress');
	}
}