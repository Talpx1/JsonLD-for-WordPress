...
class Product extends Thing{
	...
	public function description():string {
		return __("Any offered product or service. For example: a pair of shoes; a concert ticket; the rental of a car; a haircut; or an episode of a TV show streamed online.", 'jsonld-for-wordpress');
	}
}