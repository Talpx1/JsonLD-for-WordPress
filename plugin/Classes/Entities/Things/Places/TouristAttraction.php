...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Places;
...
class TouristAttraction extends Place{
	...
	public function description():string {
		return __("A tourist attraction.  In principle any Thing can be a TouristAttraction, from a Mountain and LandmarksOrHistoricalBuildings to a LocalBusiness.  This Type can be used on its own to describe a general TouristAttraction, or be used as an additionalType to add tourist attraction properties to any other type.  (See examples below)", 'jsonld-for-wordpress');
	}
}