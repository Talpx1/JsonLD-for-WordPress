...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Places\Residences;

use JsonLDForWP\Plugin\Classes\Entities\Things\Places\Residence;
...
class ApartmentComplex extends Residence{
	...
	public function description():string {
		return __("Residence type: Apartment complex.", 'jsonld-for-wordpress');
	}
}