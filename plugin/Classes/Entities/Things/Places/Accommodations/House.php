...
class House extends Accommodation{
	...
	public function description():string {
		return __("A house is a building or structure that has the ability to be occupied for habitation by humans or other creatures (source: Wikipedia, the free encyclopedia, see http://en.wikipedia.org/wiki/House).", 'jsonld-for-wordpress');
	}
}