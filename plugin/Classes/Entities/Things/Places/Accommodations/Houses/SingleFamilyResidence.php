...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Places\Accommodations\Houses;

use JsonLDForWP\Plugin\Classes\Entities\Things\Places\Accommodations\House;
...
class SingleFamilyResidence extends House{
	...
	public function description():string {
		return __("Residence type: Single-family home.", 'jsonld-for-wordpress');
	}
}