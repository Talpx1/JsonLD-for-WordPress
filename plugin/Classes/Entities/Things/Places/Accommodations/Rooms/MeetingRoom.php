...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Places\Accommodations\Rooms;

use JsonLDForWP\Plugin\Classes\Entities\Things\Places\Accommodations\Room;
...
class MeetingRoom extends Room{
	...
	public function description():string {
		return __("A meeting room, conference room, or conference hall is a room provided for singular events such as business conferences and meetings (source: Wikipedia, the free encyclopedia, see http://en.wikipedia.org/wiki/Conference_hall).\n\nSee also the dedicated document on the use of schema.org for marking up hotels and other forms of accommodations.", 'jsonld-for-wordpress');
	}
}