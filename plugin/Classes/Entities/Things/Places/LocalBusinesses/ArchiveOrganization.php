...
use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\ArchiveComponent;
...
class ArchiveOrganization extends LocalBusiness{
	protected ArchiveComponent|null $archiveHeld = null;
	...
	public function description():string {
		return __("An organization with archival holdings. An organization which keeps and preserves archival material and typically makes it accessible to the public.", 'jsonld-for-wordpress');
	}
}