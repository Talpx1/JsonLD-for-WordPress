...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Places\Landforms\BodyOfWaters;

use JsonLDForWP\Plugin\Classes\Entities\Things\Places\Landforms\BodyOfWater;
...
class Reservoir extends BodyOfWater{
	...
	public function description():string {
		return __("A reservoir of water, typically an artificially created lake, like the Lake Kariba reservoir.", 'jsonld-for-wordpress');
	}
}