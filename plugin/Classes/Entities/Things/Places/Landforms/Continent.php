...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Places\Landforms;

use JsonLDForWP\Plugin\Classes\Entities\Things\Places\Landform;
...
class Continent extends Landform{
	...
	public function description():string {
		return __("One of the continents (for example, Europe or Africa).", 'jsonld-for-wordpress');
	}
}