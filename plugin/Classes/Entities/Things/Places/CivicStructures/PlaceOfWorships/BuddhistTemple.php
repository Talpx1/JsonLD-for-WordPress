...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Places\CivicStructures\PlaceOfWorships;

use JsonLDForWP\Plugin\Classes\Entities\Things\Places\CivicStructures\PlaceOfWorship;
...
class BuddhistTemple extends PlaceOfWorship{
	...
	public function description():string {
		return __("A Buddhist temple.", 'jsonld-for-wordpress');
	}
}