...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Places\CivicStructures\PlaceOfWorships\Churches;

use JsonLDForWP\Plugin\Classes\Entities\Things\Places\CivicStructures\PlaceOfWorships\Church;
...
class CatholicChurch extends Church{
	...
	public function description():string {
		return __("A Catholic church.", 'jsonld-for-wordpress');
	}
}