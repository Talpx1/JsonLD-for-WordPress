...
class ChemicalSubstance extends BioChemEntity{
	protected string|null $chemicalComposition = null;
	...
	public function description():string {
		return __("A chemical substance is 'a portion of matter of constant composition, composed of molecular entities of the same type or of different types' (source: ChEBI:59999).", 'jsonld-for-wordpress');
	}
}