...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Actions\ControlActions;

use JsonLDForWP\Plugin\Classes\Entities\Things\Actions\ControlAction;
...
class ResumeAction extends ControlAction{
	...
	public function description():string {
		return __("The act of resuming a device or application which was formerly paused (e.g. resume music playback or resume a timer).", 'jsonld-for-wordpress');
	}
}