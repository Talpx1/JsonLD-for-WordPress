...
class TradeAction extends Action{
	...
	public function description():string {
		return __("The act of participating in an exchange of goods and services for monetary compensation. An agent trades an object, product or service with a participant in exchange for a one time or periodic payment.", 'jsonld-for-wordpress');
	}
}