...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Actions\MoveActions;

use JsonLDForWP\Plugin\Classes\Entities\Things\Actions\MoveAction;
...
class TravelAction extends MoveAction{
	...
	public function description():string {
		return __("The act of traveling from a fromLocation to a destination by a specified mode of transport, optionally with participants.", 'jsonld-for-wordpress');
	}
}