...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Actions\TransferActions;

use JsonLDForWP\Plugin\Classes\Entities\Things\Actions\TransferAction;
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\StructuredValues\MonetaryAmount;
use JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\LocalBusinesses\FinancialServices\BankOrCreditUnions\Things\Places\LocalBusinesses\FinancialServices\BankOrCreditUnion;
...
class MoneyTransfer extends TransferAction{
	...
	protected BankOrCreditUnion|string|null $beneficiaryBank = null;
	...
	public function description():string {
		return __("The act of transferring money from one place to another place. This may occur electronically or physically.", 'jsonld-for-wordpress');
	}
}