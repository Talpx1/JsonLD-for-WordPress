...
class ReceiveAction extends TransferAction{
	protected DeliveryMethod|null $deliveryMethod = null;
	protected Audience|Organization|Person|null $sender = null;
	...
	public function description():string {
		return __("The act of physically/electronically taking delivery of an object that has been transferred from an origin to a destination. Reciprocal of SendAction.\n\nRelated actions:\n\n\nSendAction: The reciprocal of ReceiveAction.\nTakeAction: Unlike TakeAction, ReceiveAction does not imply that the ownership has been transferred (e.g. I can receive a package, but it does not mean the package is now mine).\n", 'jsonld-for-wordpress');
	}
}