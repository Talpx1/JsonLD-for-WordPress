...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Actions\CreateActions;

use JsonLDForWP\Plugin\Classes\Entities\Things\Actions\CreateAction;
...
class DrawAction extends CreateAction{
	...
	public function description():string {
		return __("The act of producing a visual/graphical representation of an object, typically with a pen/pencil and paper as instruments.", 'jsonld-for-wordpress');
	}
}