...
class SolveMathAction extends Action{
	protected string|null $eduQuestionType = null;
	...
	public function description():string {
		return __("The action that takes in a math expression and directs users to a page potentially capable of solving/simplifying that expression.", 'jsonld-for-wordpress');
	}
}