...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Actions;

use JsonLDForWP\Plugin\Classes\Entities\Things\Action;
use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\HyperTocEntry;
...
class SeekToAction extends Action{
	protected HyperTocEntry|float|null $startOffset = null;
	...
	public function description():string {
		return __("This is the Action of navigating to a specific startOffset timestamp within a VideoObject, typically represented with a URL template structure.", 'jsonld-for-wordpress');
	}
}