...
class CommunicateAction extends InteractAction{
	...
	public function description():string {
		return __("The act of conveying information to another person via a communication medium (instrument) such as speech, email, or telephone conversation.", 'jsonld-for-wordpress');
	}
}