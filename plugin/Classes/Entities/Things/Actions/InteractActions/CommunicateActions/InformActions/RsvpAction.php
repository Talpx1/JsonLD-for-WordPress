...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Actions\InteractActions\CommunicateActions\InformActions;

use JsonLDForWP\Plugin\Classes\Entities\Things\Actions\InteractActions\CommunicateActions\InformAction;
use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Comment;
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Enumerations\RsvpResponseType;
...
class RsvpAction extends InformAction{
	protected float|null $additionalNumberOfGuests = null;
	protected Comment|null $comment = null;
	protected RsvpResponseType|null $rsvpResponse = null;
	...
	public function description():string {
		return __("The act of notifying an event organizer as to whether you expect to attend the event.", 'jsonld-for-wordpress');
	}
}