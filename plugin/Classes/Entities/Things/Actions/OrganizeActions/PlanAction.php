...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Actions\OrganizeActions;

use JsonLDForWP\Plugin\Classes\Entities\Things\Actions\OrganizeAction;
...
class PlanAction extends OrganizeAction{
	protected Date|DateTime|null $scheduledTime = null;
	...
	public function description():string {
		return __("The act of planning the execution of an event/task/action/reservation/plan to a future date.", 'jsonld-for-wordpress');
	}
}