...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Actions\OrganizeActions\PlanActions;

use JsonLDForWP\Plugin\Classes\Entities\Things\Actions\OrganizeActions\PlanAction;
...
class CancelAction extends PlanAction{
	...
	public function description():string {
		return __("The act of asserting that a future event/action is no longer going to happen.\n\nRelated actions:\n\n\nConfirmAction: The antonym of CancelAction.\n", 'jsonld-for-wordpress');
	}
}