...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Actions\AssessActions;

use JsonLDForWP\Plugin\Classes\Entities\Things\Actions\AssessAction;
...
class ReviewAction extends AssessAction{
	protected Review|null $resultReview = null;
	...
	public function description():string {
		return __("The act of producing a balanced opinion about the object for an audience. An agent reviews an object with participants resulting in a review.", 'jsonld-for-wordpress');
	}
}