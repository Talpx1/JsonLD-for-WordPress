...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Actions\AssessActions\ChooseActions;

use JsonLDForWP\Plugin\Classes\Entities\Things\Actions\AssessActions\ChooseAction;
...
class VoteAction extends ChooseAction{
	protected Person|null $candidate = null;
	protected string|Thing|null $actionOption = null;
	...
	public function description():string {
		return __("The act of expressing a preference from a fixed/finite/structured set of choices/options.", 'jsonld-for-wordpress');
	}
}