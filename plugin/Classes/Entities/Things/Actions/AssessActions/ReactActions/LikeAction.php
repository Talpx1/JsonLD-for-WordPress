...
class LikeAction extends ReactAction{
	...
	public function description():string {
		return __("The act of expressing a positive sentiment about the object. An agent likes an object (a proposition, topic or theme) with participants.", 'jsonld-for-wordpress');
	}
}