...
class DislikeAction extends ReactAction{
	...
	public function description():string {
		return __("The act of expressing a negative sentiment about the object. An agent dislikes an object (a proposition, topic or theme) with participants.", 'jsonld-for-wordpress');
	}
}