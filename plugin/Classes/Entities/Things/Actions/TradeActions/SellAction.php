...
class SellAction extends TradeAction{
	protected Organization|Person|null $buyer = null;
	...
	public function description():string {
		return __("The act of taking money from a buyer in exchange for goods or services rendered. An agent sells an object, product, or service to a buyer for a price. Reciprocal of BuyAction.", 'jsonld-for-wordpress');
	}
}