...
class BuyAction extends TradeAction{
	...
	public function description():string {
		return __("The act of giving money to a seller in exchange for goods or services rendered. An agent buys an object, product, or service from a seller for a price. Reciprocal of SellAction.", 'jsonld-for-wordpress');
	}
}