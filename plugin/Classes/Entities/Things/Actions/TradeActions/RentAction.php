...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Actions\TradeActions;

use JsonLDForWP\Plugin\Classes\Entities\Things\Actions\TradeAction;
use JsonLDForWP\Plugin\Classes\Entities\Things\Organization;
use JsonLDForWP\Plugin\Classes\Entities\Things\Person;
use JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\LocalBusinesses\RealEstateAgents\Things\Places\LocalBusinesses\RealEstateAgent;
...
class RentAction extends TradeAction{
	protected Organization|Person|null $landlord = null;
	protected RealEstateAgent|null $realEstateAgent = null;
	...
	public function description():string {
		return __("The act of giving money in return for temporary use, but not ownership, of an object such as a vehicle or property. For example, an agent rents a property from a landlord in exchange for a periodic payment.", 'jsonld-for-wordpress');
	}
}