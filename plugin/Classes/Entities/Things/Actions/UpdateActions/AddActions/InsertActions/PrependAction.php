...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Actions\UpdateActions\AddActions\InsertActions;

use JsonLDForWP\Plugin\Classes\Entities\Things\Actions\UpdateActions\AddActions\InsertAction;
...
class PrependAction extends InsertAction{
	...
	public function description():string {
		return __("The act of inserting at the beginning if an ordered collection.", 'jsonld-for-wordpress');
	}
}