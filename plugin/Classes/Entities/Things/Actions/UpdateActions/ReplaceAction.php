...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Actions\UpdateActions;

use JsonLDForWP\Plugin\Classes\Entities\Things\Actions\UpdateAction;
...
class ReplaceAction extends UpdateAction{
	protected Thing|null $replacee = null;
	protected Thing|null $replacer = null;
	...
	public function description():string {
		return __("The act of editing a recipient by replacing an old object with a new object.", 'jsonld-for-wordpress');
	}
}