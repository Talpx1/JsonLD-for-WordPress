...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Actions\ConsumeActions\UseActions;

use JsonLDForWP\Plugin\Classes\Entities\Things\Actions\ConsumeActions\UseAction;
...
class WearAction extends UseAction{
	...
	public function description():string {
		return __("The act of dressing oneself in clothing.", 'jsonld-for-wordpress');
	}
}