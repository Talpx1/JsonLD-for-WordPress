...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Collections;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Collection;
...
class ProductCollection extends Collection{
	...
	protected int|null $collectionSize = null;
	...
	public function description():string {
		return __("A set of products (either ProductGroups or specific variants) that are listed together e.g. in an Offer.", 'jsonld-for-wordpress');
	}
}