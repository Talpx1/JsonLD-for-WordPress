...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\PublicationIssues;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\PublicationIssue;
...
class ComicIssue extends PublicationIssue{
	protected Person|null $artist = null;
	protected Person|null $colorist = null;
	protected Person|null $inker = null;
	protected Person|null $letterer = null;
	protected Person|null $penciler = null;
	protected string|null $variantCover = null;
	...
	public function description():string {
		return __("Individual comic issues are serially published as\n        part of a larger series. For the sake of consistency, even one-shot issues\n        belong to a series comprised of a single issue. All comic issues can be\n        uniquely identified by: the combination of the name and volume number of the\n        series to which the issue belongs; the issue number; and the variant\n        description of the issue (if any).", 'jsonld-for-wordpress');
	}
}