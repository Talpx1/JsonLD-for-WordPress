...
class PublicationVolume extends CreativeWork{
	...
	protected int|string|null $volumeNumber = null;
	...
	public function description():string {
		return __("A part of a successively published publication such as a periodical or multi-volume work, often numbered. It may represent a time span, such as a year.\n\nSee also blog post.", 'jsonld-for-wordpress');
	}
}