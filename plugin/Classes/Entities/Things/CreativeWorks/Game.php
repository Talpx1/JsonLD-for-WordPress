...
class Game extends CreativeWork{
	...
	public function description():string {
		return __("The Game type represents things which are games. These are typically rule-governed recreational activities, e.g. role-playing games in which players assume the role of characters in a fictional setting.", 'jsonld-for-wordpress');
	}
}