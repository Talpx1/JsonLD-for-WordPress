...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Books;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Book;
...
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Enumerations\BookFormatType;
...
class Audiobook extends Book{
	...
	protected bool|null $abridged = null;
	protected string|null $bookEdition = null;
	protected BookFormatType|null $bookFormat = null;
	protected Person|null $illustrator = null;
	protected string|null $isbn = null;
	protected int|null $numberOfPages = null;
	...
	public function description():string {
		return __("An audiobook.", 'jsonld-for-wordpress');
	}
}