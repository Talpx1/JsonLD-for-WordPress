...
class Conversation extends CreativeWork{
	...
	public function description():string {
		return __("One or more messages between organizations or people on a particular topic. Individual messages can be linked to the conversation with isPartOf or hasPart properties.", 'jsonld-for-wordpress');
	}
}