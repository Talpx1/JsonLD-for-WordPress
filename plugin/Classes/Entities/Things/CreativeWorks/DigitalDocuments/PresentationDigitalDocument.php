...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\DigitalDocuments;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\DigitalDocument;
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\DigitalDocumentPermission;
...
class PresentationDigitalDocument extends DigitalDocument{
	protected DigitalDocumentPermission|null $hasDigitalDocumentPermission = null;
	...
	public function description():string {
		return __("A file containing slides or used for a presentation.", 'jsonld-for-wordpress');
	}
}