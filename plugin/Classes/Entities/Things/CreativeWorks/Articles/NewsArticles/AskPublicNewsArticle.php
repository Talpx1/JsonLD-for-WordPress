...
class AskPublicNewsArticle extends NewsArticle{
	...
	public function description():string {
		return __("A NewsArticle expressing an open call by a NewsMediaOrganization asking the public for input, insights, clarifications, anecdotes, documentation, etc., on an issue, for reporting purposes.", 'jsonld-for-wordpress');
	}
}