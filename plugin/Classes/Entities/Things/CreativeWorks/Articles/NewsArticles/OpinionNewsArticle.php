...
class OpinionNewsArticle extends NewsArticle{
	...
	public function description():string {
		return __("An OpinionNewsArticle is a NewsArticle that primarily expresses opinions rather than journalistic reporting of news and events. For example, a NewsArticle consisting of a column or Blog/BlogPosting entry in the Opinions section of a news publication.", 'jsonld-for-wordpress');
	}
}