...
class AdvertiserContentArticle extends Article{
	...
	public function description():string {
		return __("An Article that an external entity has paid to place or to produce to its specifications. Includes advertorials, sponsored content, native advertising and other paid content.", 'jsonld-for-wordpress');
	}
}