...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Articles\SocialMediaPostings\BlogPostings;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Articles\SocialMediaPostings\BlogPosting;
...
class LiveBlogPosting extends BlogPosting{
	protected DateTime|null $coverageEndTime = null;
	protected DateTime|null $coverageStartTime = null;
	protected BlogPosting|null $liveBlogUpdate = null;
	protected CreativeWork|null $sharedContent = null;
	...
	public function description():string {
		return __("A LiveBlogPosting is a BlogPosting intended to provide a rolling textual coverage of an ongoing event through continuous updates.", 'jsonld-for-wordpress');
	}
}