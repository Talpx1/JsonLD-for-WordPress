...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Articles\SocialMediaPostings;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Articles\SocialMediaPosting;
...
class DiscussionForumPosting extends SocialMediaPosting{
	...
	public function description():string {
		return __("A posting to a discussion forum.", 'jsonld-for-wordpress');
	}
}