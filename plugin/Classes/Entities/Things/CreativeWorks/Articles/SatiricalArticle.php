...
class SatiricalArticle extends Article{
	...
	public function description():string {
		return __("An Article whose content is primarily [satirical] in nature, i.e. unlikely to be literally true. A satirical article is sometimes but not necessarily also a NewsArticle. ScholarlyArticles are also sometimes satirized.", 'jsonld-for-wordpress');
	}
}