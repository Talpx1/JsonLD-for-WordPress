...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Articles\TechArticles;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Articles\TechArticle;
...
class APIReference extends TechArticle{
	protected string|null $assemblyVersion = null;
	protected string|null $executableLibraryName = null;
	protected string|null $programmingModel = null;
	protected string|null $targetPlatform = null;
	protected string|null $dependencies = null;
	protected string|null $proficiencyLevel = null;
	...
	public function description():string {
		return __("Reference documentation for application programming interfaces (APIs).", 'jsonld-for-wordpress');
	}
}