...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Articles\ScholarlyArticles;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Articles\ScholarlyArticle;
...
class MedicalScholarlyArticle extends ScholarlyArticle{
	protected string|null $publicationType = null;
	...
	public function description():string {
		return __("A scholarly article in the medical domain.", 'jsonld-for-wordpress');
	}
}