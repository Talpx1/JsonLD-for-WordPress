...
class Thesis extends CreativeWork{
	protected string|null $inSupportOf = null;
	...
	public function description():string {
		return __("A thesis or dissertation document submitted in support of candidature for an academic degree or professional qualification.", 'jsonld-for-wordpress');
	}
}