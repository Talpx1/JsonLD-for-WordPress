...
class Syllabus extends LearningResource{
	...
	public function description():string {
		return __("A syllabus that describes the material covered in a course, often with several such sections per Course so that a distinct timeRequired can be provided for that section of the Course.", 'jsonld-for-wordpress');
	}
}