...
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\ComputerLanguage;
...
class SoftwareSourceCode extends CreativeWork{
	protected string|null $codeRepository = null;
	protected string|null $codeSampleType = null;
	protected ComputerLanguage|string|null $programmingLanguage = null;
	protected string|null $runtimePlatform = null;
	protected SoftwareApplication|null $targetProduct = null;
	...
	public function description():string {
		return __("Computer programming source code. Example: Full (compile ready) solutions, code snippet samples, scripts, templates.", 'jsonld-for-wordpress');
	}
}