...
class Article extends CreativeWork{
	...
	public function description():string {
		return __("An article, such as a news article or piece of investigative report. Newspapers and magazines have articles of many different types and this is intended to cover them all.\n\nSee also blog post.", 'jsonld-for-wordpress');
	}
}