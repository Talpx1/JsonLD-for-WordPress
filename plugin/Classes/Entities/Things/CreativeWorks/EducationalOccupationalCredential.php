...
class EducationalOccupationalCredential extends CreativeWork{
	...
	protected DefinedTerm|string|null $credentialCategory = null;
	protected DefinedTerm|string|null $educationalLevel = null;
	protected Organization|null $recognizedBy = null;
	...
	public function description():string {
		return __("An educational or occupational credential. A diploma, academic degree, certification, qualification, badge, etc., that may be awarded to a person or other entity that meets the requirements defined by the credentialer.", 'jsonld-for-wordpress');
	}
}