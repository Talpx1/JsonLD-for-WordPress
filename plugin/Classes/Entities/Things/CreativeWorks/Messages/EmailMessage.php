...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Messages;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Message;
...
class EmailMessage extends Message{
	protected ContactPoint|Organization|Person|null $bccRecipient = null;
	protected ContactPoint|Organization|Person|null $ccRecipient = null;
	protected Date|DateTime|null $dateRead = null;
	protected DateTime|null $dateReceived = null;
	protected DateTime|null $dateSent = null;
	protected CreativeWork|null $messageAttachment = null;
	...
	protected Audience|ContactPoint|Organization|Person|null $toRecipient = null;
	...
	public function description():string {
		return __("An email message.", 'jsonld-for-wordpress');
	}
}