...
class WebSite extends CreativeWork{
	...
	public function description():string {
		return __("A WebSite is a set of related web pages and other items typically served from a single web domain and accessible via URLs.", 'jsonld-for-wordpress');
	}
}