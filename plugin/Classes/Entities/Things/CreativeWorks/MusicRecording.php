...
use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\MusicComposition;
...
class MusicRecording extends CreativeWork{
	...
	protected MusicAlbum|null $inAlbum = null;
	protected MusicPlaylist|null $inPlaylist = null;
	protected string|null $isrcCode = null;
	protected MusicComposition|null $recordingOf = null;
	...
	public function description():string {
		return __("A music recording (track), usually a single song.", 'jsonld-for-wordpress');
	}
}