...
use JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\LocalBusinesses\ArchiveOrganizations\Things\Places\LocalBusinesses\ArchiveOrganization;
...
class ArchiveComponent extends CreativeWork{
	protected ArchiveOrganization|null $holdingArchive = null;
	protected Place|PostalAddress|string|null $itemLocation = null;
	...
	public function description():string {
		return __("An intangible type to be applied to any archive content, carrying with it a set of properties required to describe archival items and collections.", 'jsonld-for-wordpress');
	}
}