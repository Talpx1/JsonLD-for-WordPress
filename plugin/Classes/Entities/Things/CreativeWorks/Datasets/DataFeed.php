...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Datasets;
...
class DataFeed extends Dataset{
	...
	public function description():string {
		return __("A single feed providing structured information about one or more entities or topics.", 'jsonld-for-wordpress');
	}
}