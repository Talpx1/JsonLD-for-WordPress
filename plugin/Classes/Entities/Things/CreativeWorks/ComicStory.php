...
class ComicStory extends CreativeWork{
	...
	public function description():string {
		return __("The term 'story' is any indivisible, re-printable\n        unit of a comic, including the interior stories, covers, and backmatter. Most\n        comics have at least two stories: a cover (ComicCoverArt) and an interior story.", 'jsonld-for-wordpress');
	}
}