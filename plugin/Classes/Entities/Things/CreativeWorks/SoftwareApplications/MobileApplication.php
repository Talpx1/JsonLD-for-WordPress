...
class MobileApplication extends SoftwareApplication{
	protected string|null $carrierRequirements = null;
	...
	public function description():string {
		return __("A software application designed specifically to work well on a mobile device such as a telephone.", 'jsonld-for-wordpress');
	}
}