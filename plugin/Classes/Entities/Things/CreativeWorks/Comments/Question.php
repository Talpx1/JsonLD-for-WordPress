...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Comments;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Comment;
use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Comments\Answer;
...
class Question extends Comment{
	protected Answer|ItemList|null $acceptedAnswer = null;
	protected int|null $answerCount = null;
	protected string|null $eduQuestionType = null;
	protected Answer|ItemList|null $suggestedAnswer = null;
	protected int|null $downvoteCount = null;
	protected Comment|null $parentItem = null;
	protected int|null $upvoteCount = null;
	...
	public function description():string {
		return __("A specific question - e.g. from a user seeking answers online, or collected in a Frequently Asked Questions (FAQ) document.", 'jsonld-for-wordpress');
	}
}