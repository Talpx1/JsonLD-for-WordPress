...
class Answer extends Comment{
	protected Comment|WebContent|null $answerExplanation = null;
	...
	public function description():string {
		return __("An answer offered to a question; perhaps correct, perhaps opinionated or wrong.", 'jsonld-for-wordpress');
	}
}