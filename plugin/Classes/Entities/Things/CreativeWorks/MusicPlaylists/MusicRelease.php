...
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Enumerations\MusicReleaseFormatType;
...
class MusicRelease extends MusicPlaylist{
	protected string|null $catalogNumber = null;
	protected Organization|Person|null $creditedTo = null;
	protected Duration|null $duration = null;
	protected MusicReleaseFormatType|null $musicReleaseFormat = null;
	protected Organization|null $recordLabel = null;
	protected MusicAlbum|null $releaseOf = null;
	...
	public function description():string {
		return __("A MusicRelease is a specific release of a music album.", 'jsonld-for-wordpress');
	}
}