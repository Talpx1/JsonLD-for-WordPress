...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\MusicPlaylists;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\MusicPlaylist;
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Enumerations\MusicAlbumProductionType;
use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\MusicPlaylists\MusicRelease;
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Enumerations\MusicAlbumReleaseType;
...
class MusicAlbum extends MusicPlaylist{
	protected MusicAlbumProductionType|null $albumProductionType = null;
	protected MusicRelease|null $albumRelease = null;
	protected MusicAlbumReleaseType|null $albumReleaseType = null;
	protected MusicGroup|Person|null $byArtist = null;
	protected int|null $numTracks = null;
	...
	public function description():string {
		return __("A collection of music tracks.", 'jsonld-for-wordpress');
	}
}