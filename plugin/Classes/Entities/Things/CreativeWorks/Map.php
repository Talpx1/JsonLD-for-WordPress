...
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Enumerations\MapCategoryType;
...
class Map extends CreativeWork{
	protected MapCategoryType|null $mapType = null;
	...
	public function description():string {
		return __("A map.", 'jsonld-for-wordpress');
	}
}