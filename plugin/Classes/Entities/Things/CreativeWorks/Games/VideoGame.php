...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Games;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Game;
use JsonLDForWP\Plugin\Classes\Entities\Things\Person;
use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWork;
use JsonLDForWP\Plugin\Classes\Entities\Thing;
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\GameServer;
...
class VideoGame extends Game{
	...
	protected string|null $gameEdition = null;
	protected string|Thing|null $gamePlatform = null;
	protected GameServer|null $gameServer = null;
	protected CreativeWork|null $gameTip = null;
	...
	protected string|null $applicationCategory = null;
	protected string|null $applicationSubCategory = null;
	protected string|null $applicationSuite = null;
	protected string|null $availableOnDevice = null;
	protected string|null $countriesNotSupported = null;
	protected string|null $countriesSupported = null;
	protected string|null $downloadUrl = null;
	protected string|null $featureList = null;
	protected string|null $fileSize = null;
	protected string|null $installUrl = null;
	protected string|null $memoryRequirements = null;
	protected string|null $operatingSystem = null;
	protected string|null $permissions = null;
	protected string|null $processorRequirements = null;
	protected string|null $releaseNotes = null;
	protected ImageObject|string|null $screenshot = null;
	protected SoftwareApplication|null $softwareAddOn = null;
	protected CreativeWork|null $softwareHelp = null;
	protected string|null $softwareRequirements = null;
	protected string|null $softwareVersion = null;
	protected string|null $storageRequirements = null;
	protected DataFeed|null $supportingData = null;
	...
	public function description():string {
		return __("A video game is an electronic game that involves human interaction with a user interface to generate visual feedback on a video device.", 'jsonld-for-wordpress');
	}
}