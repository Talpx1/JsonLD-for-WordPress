...
class MusicComposition extends CreativeWork{
	...
	protected Event|null $firstPerformance = null;
	protected MusicComposition|null $includedComposition = null;
	protected string|null $iswcCode = null;
	protected Person|null $lyricist = null;
	protected CreativeWork|null $lyrics = null;
	protected MusicComposition|null $musicArrangement = null;
	protected string|null $musicCompositionForm = null;
	protected string|null $musicalKey = null;
	protected MusicRecording|null $recordedAs = null;
	...
	public function description():string {
		return __("A musical composition.", 'jsonld-for-wordpress');
	}
}