...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\MediaObjects\VideoObjects;
...
class VideoObjectSnapshot extends VideoObject{
	...
	protected string|null $videoFrameSize = null;
	protected string|null $videoQuality = null;
	...
	public function description():string {
		return __("A specific and exact (byte-for-byte) version of a VideoObject. Two byte-for-byte identical files, for the purposes of this type, considered identical. If they have different embedded metadata the files will differ. Different external facts about the files, e.g. creator or dateCreated that aren't represented in their actual content, do not affect this notion of identity.", 'jsonld-for-wordpress');
	}
}