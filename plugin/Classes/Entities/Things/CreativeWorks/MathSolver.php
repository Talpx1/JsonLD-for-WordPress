...
use JsonLDForWP\Plugin\Classes\Entities\Things\Actions\SolveMathAction;
...
class MathSolver extends CreativeWork{
	protected SolveMathAction|string|null $mathExpression = null;
	...
	public function description():string {
		return __("A math solver which is capable of solving a subset of mathematical problems.", 'jsonld-for-wordpress');
	}
}