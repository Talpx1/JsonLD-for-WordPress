...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\DefinedTermSets;
...
class CategoryCodeSet extends DefinedTermSet{
	protected CategoryCode|null $hasCategoryCode = null;
	...
	public function description():string {
		return __("A set of Category Code values.", 'jsonld-for-wordpress');
	}
}