...
class MediaReviewItem extends CreativeWork{
	protected MediaObject|null $mediaItemAppearance = null;
	...
	public function description():string {
		return __("Represents an item or group of closely related items treated as a unit for the sake of evaluation in a MediaReview. Authorship etc. apply to the items rather than to the curation/grouping or reviewing party.", 'jsonld-for-wordpress');
	}
}