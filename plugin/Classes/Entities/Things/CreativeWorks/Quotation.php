...
class Quotation extends CreativeWork{
	protected Organization|Person|null $spokenByCharacter = null;
	...
	public function description():string {
		return __("A quotation. Often but not necessarily from some written work, attributable to a real world author and - if associated with a fictional character - to any fictional Person. Use isBasedOn to link to source/origin. The recordedIn property can be used to reference a Quotation from an Event.", 'jsonld-for-wordpress');
	}
}