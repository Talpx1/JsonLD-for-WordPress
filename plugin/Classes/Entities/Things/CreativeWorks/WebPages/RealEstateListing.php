...
class RealEstateListing extends WebPage{
	...
	public function description():string {
		return __("A RealEstateListing is a listing that describes one or more real-estate Offers (whose businessFunction is typically to lease out, or to sell).\n  The RealEstateListing type itself represents the overall listing, as manifested in some WebPage.", 'jsonld-for-wordpress');
	}
}