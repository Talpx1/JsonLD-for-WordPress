...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\WebPages;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\WebPage;
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Audiences\MedicalAudience as MedicalAudience_647e1651777bb;
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Audiences\PeopleAudiences\MedicalAudience as MedicalAudience_647e1651777bf;
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Enumerations\MedicalEnumerations\MedicalAudienceType;
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\ItemLists\BreadcrumbList;
use JsonLDForWP\Plugin\Classes\Entities\DataTypes\Date;
use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\WebPageElement;
use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\MediaObjects\ImageObject;
use JsonLDForWP\Plugin\Classes\Entities\Things\Organization;
use JsonLDForWP\Plugin\Classes\Entities\Things\Person;
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\SpeakableSpecification;
...
class MedicalWebPage extends WebPage{
	protected MedicalAudience_647e1651777bb|MedicalAudience_647e1651777bf|MedicalAudienceType|null $medicalAudience = null;
	protected BreadcrumbList|string|null $breadcrumb = null;
	protected Date|null $lastReviewed = null;
	protected WebPageElement|null $mainContentOfPage = null;
	protected ImageObject|null $primaryImageOfPage = null;
	protected string|null $relatedLink = null;
	protected Organization|Person|null $reviewedBy = null;
	protected string|null $significantLink = null;
	protected SpeakableSpecification|string|null $speakable = null;
	protected Specialty|null $specialty = null;
	...
	public function description():string {
		return __("A web page that provides medical information.", 'jsonld-for-wordpress');
	}
}