...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\WebPages\CollectionPages;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\WebPages\CollectionPage;
...
class MediaGallery extends CollectionPage{
	...
	public function description():string {
		return __("Web page type: Media gallery page. A mixed-media page that can contain media such as images, videos, and other multimedia.", 'jsonld-for-wordpress');
	}
}