...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Reviews\CriticReviews;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Reviews\CriticReview;
...
class ReviewNewsArticle extends CriticReview{
	protected Review|null $associatedClaimReview = null;
	protected Review|null $associatedMediaReview = null;
	protected Review|null $associatedReview = null;
	...
	protected string|null $reviewBody = null;
	protected Rating|null $reviewRating = null;
	protected string|null $dateline = null;
	protected string|null $printColumn = null;
	protected string|null $printEdition = null;
	protected string|null $printPage = null;
	protected string|null $printSection = null;
	protected string|null $articleBody = null;
	protected string|null $articleSection = null;
	protected CreativeWork|string|null $backstory = null;
	protected int|string|null $pageEnd = null;
	protected int|string|null $pageStart = null;
	protected string|null $pagination = null;
	...
	public function description():string {
		return __("A NewsArticle and CriticReview providing a professional critic's assessment of a service, product, performance, or artistic or literary work.", 'jsonld-for-wordpress');
	}
}