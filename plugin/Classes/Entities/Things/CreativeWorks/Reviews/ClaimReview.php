...
class ClaimReview extends Review{
	protected string|null $claimReviewed = null;
	...
	public function description():string {
		return __("A fact-checking review of claims made (or reported) in some creative work (referenced via itemReviewed).", 'jsonld-for-wordpress');
	}
}