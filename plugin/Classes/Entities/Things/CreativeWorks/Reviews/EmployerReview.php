...
class EmployerReview extends Review{
	...
	public function description():string {
		return __("An EmployerReview is a review of an Organization regarding its role as an employer, written by a current or former employee of that organization.", 'jsonld-for-wordpress');
	}
}