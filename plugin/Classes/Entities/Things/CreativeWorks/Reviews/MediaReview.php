...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Reviews;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Review;
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Enumerations\MediaManipulationRatingEnumeration;
...
class MediaReview extends Review{
	protected MediaManipulationRatingEnumeration|null $mediaAuthenticityCategory = null;
	protected string|null $originalMediaContextDescription = null;
	protected MediaObject|string|WebPage|null $originalMediaLink = null;
	...
	public function description():string {
		return __("A MediaReview is a more specialized form of Review dedicated to the evaluation of media content online, typically in the context of fact-checking and misinformation.\n    For more general reviews of media in the broader sense, use UserReview, CriticReview or other Review types. This definition is\n    a work in progress. While the MediaManipulationRatingEnumeration list reflects significant community review amongst fact-checkers and others working\n    to combat misinformation, the specific structures for representing media objects, their versions and publication context, are still evolving. Similarly, best practices for the relationship between MediaReview and ClaimReview markup have not yet been finalized.", 'jsonld-for-wordpress');
	}
}