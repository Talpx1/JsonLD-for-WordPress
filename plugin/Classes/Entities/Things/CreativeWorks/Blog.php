...
class Blog extends CreativeWork{
	protected BlogPosting|null $blogPost = null;
	...
	public function description():string {
		return __("A blog, sometimes known as a 'weblog'. Note that the individual posts (BlogPostings) in a Blog are often colloquially referred to by the same term.", 'jsonld-for-wordpress');
	}
}