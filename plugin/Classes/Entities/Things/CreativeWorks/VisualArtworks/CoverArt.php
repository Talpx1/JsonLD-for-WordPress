...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\VisualArtworks;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\VisualArtwork;
...
class CoverArt extends VisualArtwork{
	...
	public function description():string {
		return __("The artwork on the outer surface of a CreativeWork.", 'jsonld-for-wordpress');
	}
}