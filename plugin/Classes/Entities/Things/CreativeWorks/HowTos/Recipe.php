...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\HowTos;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\HowTo;
...
use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\HowToSections\Things\Intangibles\ItemLists\HowToSections\Things\Intangibles\ListItems\HowToSection;
use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\HowToSteps\Things\Intangibles\ItemLists\HowToSteps\Things\Intangibles\ListItems\HowToStep;
...
class Recipe extends HowTo{
	protected Duration|null $cookTime = null;
	protected string|null $cookingMethod = null;
	protected NutritionInformation|null $nutrition = null;
	protected string|null $recipeCategory = null;
	protected string|null $recipeCuisine = null;
	protected string|null $recipeIngredient = null;
	protected CreativeWork|ItemList|string|null $recipeInstructions = null;
	protected QuantitativeValue|string|null $recipeYield = null;
	...
	protected CreativeWork|HowToSection|HowToStep|string|null $step = null;
	...
	protected QuantitativeValue|string|null $yield = null;
	...
	public function description():string {
		return __("A recipe. For dietary restrictions covered by the recipe, a few common restrictions are enumerated via suitableForDiet. The keywords property can also be used to add more detail.", 'jsonld-for-wordpress');
	}
}