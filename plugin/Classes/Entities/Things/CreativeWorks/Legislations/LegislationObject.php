...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Legislations;

use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Legislation;
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Enumerations\LegalValueLevel;
...
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Enumerations\StatusEnumerations\LegalForceStatus;
...
class LegislationObject extends Legislation{
	protected LegalValueLevel|null $legislationLegalValue = null;
	protected AdministrativeArea|string|null $jurisdiction = null;
	protected Legislation|null $legislationApplies = null;
	protected Legislation|null $legislationChanges = null;
	protected Legislation|null $legislationConsolidates = null;
	protected Date|null $legislationDate = null;
	protected Date|null $legislationDateVersion = null;
	protected string|null $legislationIdentifier = null;
	protected AdministrativeArea|string|null $legislationJurisdiction = null;
	protected LegalForceStatus|null $legislationLegalForce = null;
	protected Organization|Person|null $legislationPassedBy = null;
	protected Organization|Person|null $legislationResponsible = null;
	protected Legislation|null $legislationTransposes = null;
	protected CategoryCode|string|null $legislationType = null;
	...
	public function description():string {
		return __("A specific object or file containing a Legislation. Note that the same Legislation can be published in multiple files. For example, a digitally signed PDF, a plain PDF and an HTML version.", 'jsonld-for-wordpress');
	}
}