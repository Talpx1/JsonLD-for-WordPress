...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\OnlineBusinesses;

use JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\OnlineBusiness;
...
class OnlineStore extends OnlineBusiness{
	...
	public function description():string {
		return __("An eCommerce site.", 'jsonld-for-wordpress');
	}
}