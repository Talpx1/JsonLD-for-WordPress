...
class MedicalClinic extends MedicalBusiness{
	...
	protected MedicalSpecialty|null $medicalSpecialty = null;
	...
	public function description():string {
		return __("A facility, often associated with a hospital or medical school, that is devoted to the specific diagnosis and/or healthcare. Previously limited to outpatients but with evolution it may be open to inpatients as well.", 'jsonld-for-wordpress');
	}
}