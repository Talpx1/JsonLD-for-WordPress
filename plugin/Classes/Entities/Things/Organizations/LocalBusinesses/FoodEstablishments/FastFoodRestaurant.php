...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\LocalBusinesses\FoodEstablishments;

use JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\LocalBusinesses\FoodEstablishment;
use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\Menu;
...
class FastFoodRestaurant extends FoodEstablishment{
	protected bool|string|null $acceptsReservations = null;
	protected Menu|string|null $hasMenu = null;
	protected string|null $servesCuisine = null;
	...
	public function description():string {
		return __("A fast-food restaurant.", 'jsonld-for-wordpress');
	}
}