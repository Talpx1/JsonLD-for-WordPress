...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\LocalBusinesses\EntertainmentBusinesses;

use JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\LocalBusinesses\EntertainmentBusiness;
...
class MovieTheater extends EntertainmentBusiness{
	protected float|null $screenCount = null;
	...
	public function description():string {
		return __("A movie theater.", 'jsonld-for-wordpress');
	}
}