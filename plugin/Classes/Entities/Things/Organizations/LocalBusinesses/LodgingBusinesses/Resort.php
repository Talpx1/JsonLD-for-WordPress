...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\LocalBusinesses\LodgingBusinesses;

use JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\LocalBusinesses\LodgingBusiness;
...
class Resort extends LodgingBusiness{
	...
	protected Rating|null $starRating = null;
	...
	public function description():string {
		return __("A resort is a place used for relaxation or recreation, attracting visitors for holidays or vacations. Resorts are places, towns or sometimes commercial establishments operated by a single company (source: Wikipedia, the free encyclopedia, see http://en.wikipedia.org/wiki/Resort).\n\nSee also the dedicated document on the use of schema.org for marking up hotels and other forms of accommodations.", 'jsonld-for-wordpress');
	}
}