...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\LocalBusinesses\HomeAndConstructionBusinesses;

use JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\LocalBusinesses\HomeAndConstructionBusiness;
...
class HVACBusiness extends HomeAndConstructionBusiness{
	...
	public function description():string {
		return __("A business that provides Heating, Ventilation and Air Conditioning services.", 'jsonld-for-wordpress');
	}
}