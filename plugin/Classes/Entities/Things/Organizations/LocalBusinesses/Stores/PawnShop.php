...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\LocalBusinesses\Stores;

use JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\LocalBusinesses\Store;
...
class PawnShop extends Store{
	...
	public function description():string {
		return __("A shop that will buy, or lend money against the security of, personal possessions.", 'jsonld-for-wordpress');
	}
}