...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\Projects;

use JsonLDForWP\Plugin\Classes\Entities\Things\Organizations\Project;
...
class FundingAgency extends Project{
	...
	public function description():string {
		return __("A FundingAgency is an organization that implements one or more FundingSchemes and manages\n    the granting process (via Grants, typically MonetaryGrants).\n    A funding agency is not always required for grant funding, e.g. philanthropic giving, corporate sponsorship etc.\n\nExamples of funding agencies include ERC, REA, NIH, Bill and Melinda Gates Foundation, ...", 'jsonld-for-wordpress');
	}
}