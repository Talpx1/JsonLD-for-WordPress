...
class OnlineBusiness extends Organization{
	...
	public function description():string {
		return __("A particular online business, either standalone or the online part of a broader organization. Examples include an eCommerce site, an online travel booking site, an online learning site, an online logistics and shipping provider, an online (virtual) doctor, etc.", 'jsonld-for-wordpress');
	}
}