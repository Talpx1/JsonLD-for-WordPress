...
class LocalBusiness extends Organization{
	...
	public function description():string {
		return __("A particular physical business or branch of an organization. Examples of LocalBusiness include a restaurant, a particular branch of a restaurant chain, a branch of a bank, a medical practice, a club, a bowling alley, etc.", 'jsonld-for-wordpress');
	}
}