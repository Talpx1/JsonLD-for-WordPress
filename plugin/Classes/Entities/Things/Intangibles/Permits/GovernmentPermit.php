...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Permits;

use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Permit;
...
class GovernmentPermit extends Permit{
	...
	public function description():string {
		return __("A permit issued by a government agency.", 'jsonld-for-wordpress');
	}
}