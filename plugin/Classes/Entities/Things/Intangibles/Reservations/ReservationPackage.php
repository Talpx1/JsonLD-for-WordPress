...
class ReservationPackage extends Reservation{
	protected Reservation|null $subReservation = null;
	...
	public function description():string {
		return __("A group of multiple reservations with common values for all sub-reservations.", 'jsonld-for-wordpress');
	}
}