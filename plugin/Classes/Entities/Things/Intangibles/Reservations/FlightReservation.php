...
class FlightReservation extends Reservation{
	protected string|null $boardingGroup = null;
	protected QualitativeValue|string|null $passengerPriorityStatus = null;
	protected string|null $passengerSequenceNumber = null;
	protected string|null $securityScreening = null;
