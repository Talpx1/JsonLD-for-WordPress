...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Series\CreativeWorkSeries\Periodicals;

use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Series\CreativeWorkSeries\Periodical;
...
class Newspaper extends Periodical{
	...
	public function description():string {
		return __("A publication containing information about varied topics that are pertinent to general information, a geographic area, or a specific subject matter (i.e. business, culture, education). Often published daily.", 'jsonld-for-wordpress');
	}
}