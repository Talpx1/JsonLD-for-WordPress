...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Series\CreativeWorkSeries;

use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Series\CreativeWorkSeries;
...
class PodcastSeries extends CreativeWorkSeries{
	...
	public function description():string {
		return __("A podcast is an episodic series of digital audio or video files which a user can download and listen to.", 'jsonld-for-wordpress');
	}
}