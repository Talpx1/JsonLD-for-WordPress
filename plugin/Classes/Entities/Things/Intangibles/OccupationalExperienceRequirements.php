...
class OccupationalExperienceRequirements extends Intangible{
	protected float|null $monthsOfExperience = null;
	...
	public function description():string {
		return __("Indicates employment-related experience requirements, e.g. monthsOfExperience.", 'jsonld-for-wordpress');
	}
}