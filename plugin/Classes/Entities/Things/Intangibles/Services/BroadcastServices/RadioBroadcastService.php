...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Services\BroadcastServices;
...
class RadioBroadcastService extends BroadcastService{
	protected Organization|null $broadcastAffiliateOf = null;
	protected string|null $broadcastDisplayName = null;
	protected BroadcastFrequencySpecification|string|null $broadcastFrequency = null;
	protected string|null $broadcastTimezone = null;
	protected Organization|null $broadcaster = null;
	protected string|null $callSign = null;
	protected BroadcastChannel|null $hasBroadcastChannel = null;
	protected Language|string|null $inLanguage = null;
	protected BroadcastService|null $parentService = null;
	protected string|null $videoFormat = null;
	...
	public function description():string {
		return __("A delivery service through which radio content is provided via broadcast over the air or online.", 'jsonld-for-wordpress');
	}
}