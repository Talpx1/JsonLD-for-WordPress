...
class WebAPI extends Service{
	protected CreativeWork|string|null $documentation = null;
	...
	public function description():string {
		return __("An application programming interface accessible over Web/Internet technologies.", 'jsonld-for-wordpress');
	}
}