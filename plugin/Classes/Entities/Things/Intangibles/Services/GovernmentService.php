...
class GovernmentService extends Service{
	protected AdministrativeArea|string|null $jurisdiction = null;
	protected Organization|null $serviceOperator = null;
	...
	public function description():string {
		return __("A service provided by a government organization, e.g. food stamps, veterans benefits, etc.", 'jsonld-for-wordpress');
	}
}