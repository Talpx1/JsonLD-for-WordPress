...
class PaymentCard extends FinancialProduct{
	protected bool|float|null $cashBack = null;
	protected bool|null $contactlessPayment = null;
	protected MonetaryAmount|null $floorLimit = null;
	protected MonetaryAmount|float|null $monthlyMinimumRepaymentAmount = null;
	...
	public function description():string {
		return __("A payment method using a credit, debit, store or other card to associate the payment with an account.", 'jsonld-for-wordpress');
	}
}