...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Services\FinancialProducts\LoanOrCredits;
...
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\StructuredValues\RepaymentSpecification;
...
class MortgageLoan extends LoanOrCredit{
	protected bool|null $domiciledMortgage = null;
	protected MonetaryAmount|null $loanMortgageMandateAmount = null;
	protected MonetaryAmount|float|null $amount = null;
	protected string|null $currency = null;
	protected Duration|null $gracePeriod = null;
	protected RepaymentSpecification|null $loanRepaymentForm = null;
	protected QuantitativeValue|null $loanTerm = null;
	protected string|null $loanType = null;
	protected bool|null $recourseLoan = null;
	protected bool|null $renegotiableLoan = null;
	protected string|Thing|null $requiredCollateral = null;
	...
	public function description():string {
		return __("A loan in which property or real estate is used as collateral. (A loan securitized against some real estate.)", 'jsonld-for-wordpress');
	}
}