...
class InvestmentOrDeposit extends FinancialProduct{
	...
	public function description():string {
		return __("A type of financial product that typically requires the client to transfer funds to a financial service in return for potential beneficial financial return.", 'jsonld-for-wordpress');
	}
}