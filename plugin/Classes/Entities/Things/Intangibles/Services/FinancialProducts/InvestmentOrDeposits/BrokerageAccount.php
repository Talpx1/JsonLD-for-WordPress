...
class BrokerageAccount extends InvestmentOrDeposit{
	...
	public function description():string {
		return __("An account that allows an investor to deposit funds and place investment orders with a licensed broker or brokerage firm.", 'jsonld-for-wordpress');
	}
}