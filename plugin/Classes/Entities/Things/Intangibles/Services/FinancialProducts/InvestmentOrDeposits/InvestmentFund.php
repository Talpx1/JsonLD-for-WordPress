...
class InvestmentFund extends InvestmentOrDeposit{
	...
	public function description():string {
		return __("A company or fund that gathers capital from a number of investors to create a pool of money that is then re-invested into stocks, bonds and other assets.", 'jsonld-for-wordpress');
	}
}