...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Services\FinancialProducts\InvestmentOrDeposits;

use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Services\FinancialProducts\InvestmentOrDeposit;
...
class DepositAccount extends InvestmentOrDeposit{
	protected MonetaryAmount|null $accountMinimumInflow = null;
	protected MonetaryAmount|null $accountOverdraftLimit = null;
	protected string|null $bankAccountType = null;
	...
	public function description():string {
		return __("A type of Bank Account with a main purpose of depositing funds to gain interest or other benefits.", 'jsonld-for-wordpress');
	}
}