...
class BankAccount extends FinancialProduct{
	...
	public function description():string {
		return __("A product or service offered by a bank whereby one may deposit, withdraw or transfer money and in some cases be paid interest.", 'jsonld-for-wordpress');
	}
}