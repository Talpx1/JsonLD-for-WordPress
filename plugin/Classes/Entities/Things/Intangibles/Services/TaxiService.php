...
class TaxiService extends Service{
	...
	public function description():string {
		return __("A service for a vehicle for hire with a driver for local travel. Fares are usually calculated based on distance traveled.", 'jsonld-for-wordpress');
	}
}