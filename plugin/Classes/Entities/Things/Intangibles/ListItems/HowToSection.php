...
class HowToSection extends ListItem{
	...
	public function description():string {
		return __("A sub-grouping of steps in the instructions for how to achieve a result (e.g. steps for making a pie crust within a pie recipe).", 'jsonld-for-wordpress');
	}
}