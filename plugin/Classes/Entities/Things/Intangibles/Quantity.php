...
class Quantity extends Intangible{
	...
	public function description():string {
		return __("Quantities such as distance, time, mass, weight, etc. Particular instances of say Mass are entities like '3 kg' or '4 milligrams'.", 'jsonld-for-wordpress');
	}
}