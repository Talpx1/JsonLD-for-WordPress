...
class ShippingDeliveryTime extends StructuredValue{
	protected OpeningHoursSpecification|null $businessDays = null;
	protected Time|null $cutoffTime = null;
	protected QuantitativeValue|null $handlingTime = null;
	protected QuantitativeValue|null $transitTime = null;
	...
	public function description():string {
		return __("ShippingDeliveryTime provides various pieces of information about delivery times for shipping.", 'jsonld-for-wordpress');
	}
}