...
use JsonLDForWP\Plugin\Classes\Entities\Things\CreativeWorks\WebSite;
...
class InteractionCounter extends StructuredValue{
	...
	protected SoftwareApplication|WebSite|null $interactionService = null;
	protected Action|null $interactionType = null;
	protected Place|PostalAddress|string|VirtualLocation|null $location = null;
	protected DateTime|Time|null $startTime = null;
	protected int|null $userInteractionCount = null;
	...
	public function description():string {
		return __("A summary of how users have interacted with this CreativeWork. In most cases, authors will use a subtype to specify the specific type of interaction.", 'jsonld-for-wordpress');
	}
}