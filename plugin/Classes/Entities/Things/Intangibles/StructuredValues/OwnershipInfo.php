...
class OwnershipInfo extends StructuredValue{
	...
	protected DateTime|null $ownedFrom = null;
	protected DateTime|null $ownedThrough = null;
	...
	public function description():string {
		return __("A structured value providing information about when a certain organization or person owned a certain product.", 'jsonld-for-wordpress');
	}
}