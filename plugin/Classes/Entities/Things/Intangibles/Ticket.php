...
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Seat;
...
class Ticket extends Intangible{
	protected Date|DateTime|null $dateIssued = null;
	protected Organization|null $issuedBy = null;
	protected string|null $priceCurrency = null;
	protected string|null $ticketNumber = null;
	protected string|null $ticketToken = null;
	protected Seat|null $ticketedSeat = null;
	...
	public function description():string {
		return __("Used to describe a ticket to an event, a flight, a bus ride, etc.", 'jsonld-for-wordpress');
	}
}