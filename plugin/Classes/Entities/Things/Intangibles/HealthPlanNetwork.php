...
class HealthPlanNetwork extends Intangible{
	...
	protected string|null $healthPlanNetworkId = null;
	protected string|null $healthPlanNetworkTier = null;
	...
	public function description():string {
		return __("A US-style health insurance plan network.", 'jsonld-for-wordpress');
	}
}