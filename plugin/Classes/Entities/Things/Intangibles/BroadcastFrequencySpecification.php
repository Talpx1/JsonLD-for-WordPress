...
class BroadcastFrequencySpecification extends Intangible{
	...
	protected QualitativeValue|string|null $broadcastSignalModulation = null;
	protected string|null $broadcastSubChannel = null;
	...
	public function description():string {
		return __("The frequency in MHz and the modulation used for a particular BroadcastService.", 'jsonld-for-wordpress');
	}
}