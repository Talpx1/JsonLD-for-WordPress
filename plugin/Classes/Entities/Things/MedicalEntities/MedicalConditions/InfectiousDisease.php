...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\MedicalEntities\MedicalConditions;

use JsonLDForWP\Plugin\Classes\Entities\Things\MedicalEntities\MedicalCondition;
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\Enumerations\MedicalEnumerations\InfectiousAgentClass;
...
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\DefinedTerms\CategoryCodes\MedicalCodes\Things\MedicalEntities\MedicalIntangibles\MedicalCode as MedicalCode_647e16fe8a0c9;
use JsonLDForWP\Plugin\Classes\Entities\Things\Intangibles\DefinedTerms\CategoryCodes\MedicalCode as MedicalCode_647e16fe8a0cb;
use JsonLDForWP\Plugin\Classes\Entities\Things\MedicalEntities\MedicalIntangibles\MedicalCode as MedicalCode_647e16fe8a0cc;
...
class InfectiousDisease extends MedicalCondition{
	protected string|null $infectiousAgent = null;
	protected InfectiousAgentClass|null $infectiousAgentClass = null;
	protected string|null $transmissionMethod = null;
	...
	protected MedicalCode_647e16fe8a0c9|MedicalCode_647e16fe8a0cb|MedicalCode_647e16fe8a0cc|null $code = null;
	...
	public function description():string {
		return __("An infectious disease is a clinically evident human disease resulting from the presence of pathogenic microbial agents, like pathogenic viruses, pathogenic bacteria, fungi, protozoa, multicellular parasites, and prions. To be considered an infectious disease, such pathogens are known to be able to cause this disease.", 'jsonld-for-wordpress');
	}
}