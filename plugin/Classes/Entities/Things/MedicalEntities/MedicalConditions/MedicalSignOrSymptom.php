...
class MedicalSignOrSymptom extends MedicalCondition{
	...
	public function description():string {
		return __("Any feature associated or not with a medical condition. In medicine a symptom is generally subjective while a sign is objective.", 'jsonld-for-wordpress');
	}
}