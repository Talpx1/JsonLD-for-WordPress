...
class LifestyleModification extends MedicalEntity{
	...
	public function description():string {
		return __("A process of care involving exercise, changes to diet, fitness routines, and other lifestyle changes aimed at improving a health condition.", 'jsonld-for-wordpress');
	}
}