...
class MedicalIndication extends MedicalEntity{
	...
	public function description():string {
		return __("A condition or factor that indicates use of a medical therapy, including signs, symptoms, risk factors, anatomical states, etc.", 'jsonld-for-wordpress');
	}
}