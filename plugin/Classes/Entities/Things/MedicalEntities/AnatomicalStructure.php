...
class AnatomicalStructure extends MedicalEntity{
	...
	public function description():string {
		return __("Any part of the human body, typically a component of an anatomical system. Organs, tissues, and cells are all anatomical structures.", 'jsonld-for-wordpress');
	}
}