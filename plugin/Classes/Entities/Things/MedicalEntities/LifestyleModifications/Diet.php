...
class Diet extends LifestyleModification{
	protected string|null $dietFeatures = null;
	protected Organization|Person|null $endorsers = null;
	protected string|null $expertConsiderations = null;
	protected string|null $physiologicalBenefits = null;
	protected string|null $risks = null;
	...
	public function description():string {
		return __("A strategy of regulating the intake of food to achieve or maintain a specific health-related goal.", 'jsonld-for-wordpress');
	}
}