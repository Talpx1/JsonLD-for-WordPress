...
namespace JsonLDForWP\Plugin\Classes\Entities\Things\MedicalEntities\LifestyleModifications\PhysicalActivities;

use JsonLDForWP\Plugin\Classes\Entities\Things\MedicalEntities\LifestyleModifications\PhysicalActivity;
...
class ExercisePlan extends PhysicalActivity{
	protected Duration|QuantitativeValue|null $activityDuration = null;
	protected QuantitativeValue|string|null $activityFrequency = null;
	protected string|null $additionalVariable = null;
	protected string|null $exerciseType = null;
	protected QuantitativeValue|string|null $intensity = null;
	protected float|QuantitativeValue|null $repetitions = null;
	protected QuantitativeValue|string|null $restPeriods = null;
	protected Energy|QuantitativeValue|null $workload = null;
	...
	public function description():string {
		return __("Fitness-related activity designed for a specific health-related purpose, including defined exercise routines as well as activity prescribed by a clinician.", 'jsonld-for-wordpress');
	}
}