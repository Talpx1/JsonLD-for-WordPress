...
class MedicalProcedure extends MedicalEntity{
	...
	public function description():string {
		return __("A process of care used in either a diagnostic, therapeutic, preventive or palliative capacity that relies on invasive (surgical), non-invasive, or other techniques.", 'jsonld-for-wordpress');
	}
}